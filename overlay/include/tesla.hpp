...
namespace tsl {
    ...
    namespace elm {
        ...
        public:
             ...
             * @param footer Footer drawn at the bottom of the Overlay
             */
            OverlayFrame(const std::string& title, const std::string& subtitle, const std::string& footer = "\uE0E1  Back     \uE0E0  OK") : Element(), m_title(title), m_subtitle(subtitle), m_footer(footer) {}
            ...
            /**
             * @brief Changes the footer of the menu
             *
             * @param footer Footer to change to
             */
